...
class OpinionControllerTest extends RestAssuredSpringBootTest {
    ...
    @DisplayName("POST /follow-up-issue/opinion 요청을 보낼 때 이미 동일한 단락에 대한 의견이 존재하는 경우, 상태 코드 400을 반환한다.")
    @Test
    ...
    void createReprocessedIssueOpinion() {
        ...
        final ReprocessedIssueOpinionCreateRequest request = ReprocessedIssueOpinionCreateRequest.of(paragraph.getId(),
                                                                                                     reprocessedIssueId,
                                                                                                     "내용", true);
        final Member member = memberRepository.save(Member.forSave("이름", "image"));

        // when
        final var response = RestAssured.given().log().all()
            .header(HttpHeaders.AUTHORIZATION,
                    "Bearer " + tokenProvider.createAccessToken(member.getId()))
            .contentType(ContentType.JSON)
            .body(request)
            .when().log().all()
    ...
    void createReprocessedIssueOpinion_alreadyExistedOpinion() {
        ...
        reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph.getId(), reprocessedIssueId, true, member.getId(), "내용"));
    ...
    void updateFollowUpIssueOpinion_NotMatchedOpinion() {
        ...
        final FollowUpIssueParagraph paragraph2 = followUpIssueParagraphRepository.save(
            FollowUpIssueParagraph.forSave("내용", false, followUpIssueId));
        final long memberId = memberRepository.save(Member.forSave("이름1", "image")).getId();
        final long otherMemberId = memberRepository.save(Member.forSave("이름2", "image")).getId();
        final FollowUpIssueOpinion opinion = followUpIssueOpinionRepository.save(
    ...
    void getMyReprocessedIssueOpinions() {
        ...
        final ReprocessedIssueOpinion opinion2 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph2.getId(), reprocessedIssueId, true, member.getId(), "내용"));
    ...
    void getReprocessedIssueOpinions() {
        ...
        final Member member2 = memberRepository.save(Member.forSave("이름", "image"));

        final ReprocessedIssueOpinion opinion = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph.getId(), reprocessedIssueId, true, member1.getId(), "내용1"));
        final ReprocessedIssueOpinion opinion2 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph2.getId(), reprocessedIssueId, true, member2.getId(), "내용2"));
    ...
    void getReprocessedIssueOpinionsByDoubt() {
        ...
        final ReprocessedIssueOpinion opinion = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph.getId(), reprocessedIssueId, true, member1.getId(), "내용1"));
        final ReprocessedIssueOpinion opinion2 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph2.getId(), reprocessedIssueId, false, member2.getId(), "내용2"));
        reprocessedIssueOpinionLikeRepository.save(
            ReprocessedIssueOpinionLike.forSave(1L, opinion.getId()));
    ...
    void getTopReprocessedIssueOpinions() {
        ...
        final ReprocessedIssueOpinion opinion = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph.getId(), reprocessedIssueId, true, member1.getId(), "내용1"));
        final ReprocessedIssueOpinion opinion2 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph2.getId(), reprocessedIssueId, true, member1.getId(), "내용2"));
        final ReprocessedIssueOpinion opinion3 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph3.getId(), reprocessedIssueId, true, member1.getId(), "내용3"));
        final ReprocessedIssueOpinion opinion4 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph3.getId(), reprocessedIssueId, true, member1.getId(), "내용4"));
        final ReprocessedIssueOpinion opinion5 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph3.getId(), reprocessedIssueId, true, member1.getId(), "내용5"));
        final ReprocessedIssueOpinion opinion6 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph3.getId(), reprocessedIssueId, true, member1.getId(), "내용6"));

        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(1L, opinion.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(2L, opinion.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(3L, opinion.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(2L, opinion2.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(1L, opinion2.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(3L, opinion2.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(1L, opinion3.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(2L, opinion3.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(3L, opinion4.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(4L, opinion4.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(5L, opinion5.getId()));
        reprocessedIssueOpinionLikeRepository.save(ReprocessedIssueOpinionLike.forSave(1L, opinion6.getId()));
        ...
        assertAll(
            ...
            () -> assertThat(responses).extracting(ReprocessedIssueOpinionResponse::getId)
                .containsExactly(opinion2.getId(), opinion.getId(), opinion4.getId(),
                                 opinion3.getId(),
                                 opinion6.getId())
        );
    }
    ...
    void getReprocessedIssueOpinionsOrderByParagraphByDoubt() {
        ...
        final ReprocessedIssueOpinion opinion = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph.getId(), reprocessedIssueId, true, member1.getId(), "내용1"));
        final ReprocessedIssueOpinion opinion2 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph2.getId(), reprocessedIssueId, false, member1.getId(), "내용2"));
        final ReprocessedIssueOpinion opinion3 = reprocessedIssueOpinionRepository.save(
            ReprocessedIssueOpinion.forSave(paragraph3.getId(), reprocessedIssueId, true, member1.getId(), "내용3"));
        ...
        final var responses = RestAssured.given().log().all()
            ...
            .contentType(ContentType.JSON)
            .when().log().all()
            .get("/reprocessed-issue/{issueId}/opinion/paragraph?viewMode=doubt",
                 reprocessedIssueId)
            .then().log().all()
            .statusCode(HttpStatus.OK.value())
            .extract()
