...
public class RecentAllOpinionOrderStrategy implements AllOpinionOrderStrategy {
    ...
    public List<IssueOpinionMapping> getOpinionsByReliabilitiesOrderBy(final Long issueId,
        ...
        return reprocessedIssueRepository.findAllCommentsOrderByCreatedAtDesc(issueId, followUpIssueIds, reliabilities,
                                                                              pageable);
    }
}
