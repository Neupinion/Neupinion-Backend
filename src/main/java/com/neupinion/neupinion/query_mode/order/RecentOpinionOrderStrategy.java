...
public class RecentOpinionOrderStrategy implements OpinionOrderStrategy {
    ...
    public List<ReprocessedIssueOpinion> getOpinionsByParagraphOrderBy(final Long paragraphId,
                                                                       final List<Boolean> reliabilities,
                                                                       final Pageable pageable) {
        return reprocessedIssueOpinionRepository.findTop5ByParagraphIdOrderByCreatedAt(paragraphId, reliabilities,
                                                                                       pageable);
    }
}
