...
import com.neupinion.neupinion.auth.exception.TokenException.ExpiredTokenException;
import com.neupinion.neupinion.auth.exception.TokenException.NotIssuedTokenException;
...
public class TokenProvider {
    ...
    public Claims parseClaims(final String token) {
        try {
            ...
            throw new NotIssuedTokenException();
